...
> ⚠️ **MINUTA — não validada juridicamente.** Redigida a partir do funcionamento
> real do sistema. Recomenda-se revisão por advogado antes ou logo após o
> lançamento. Ver `docs/superpowers/specs/2026-08-01-landing-page-design.md`.
